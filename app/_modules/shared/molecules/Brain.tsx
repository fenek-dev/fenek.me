  ...
  return (
    <>
      ...
      >
        ...
        <motion.g className="group " {...partAnimation(0)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(1)}>
          <path
        ...
        <motion.path
          ...
          {...partAnimation(4, 1.2)}
        />
        <motion.g className="group" {...partAnimation(4)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(5)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(6)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(7)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(8)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(9)}>
          <path
        ...
        {/* 4 */}
        <motion.g className="group" {...partAnimation(10)}>
          <path
        ...
        />
        <motion.g className="group" {...partAnimation(11)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(12)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(13)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(14)}>
          <path
        ...
        <motion.g className="group" {...partAnimation(15)}>
          <path
